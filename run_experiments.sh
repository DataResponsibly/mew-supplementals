...
PYTHONPATH=./ python 'experiments/synthetic/mpw_parallel_pluarlity/experiment.py' >> 'experiments/synthetic/mpw_parallel_pluarlity/printout.txt'
PYTHONPATH=./ python 'experiments/synthetic/mpw_parallel_borda/experiment.py' True >> 'experiments/synthetic/mpw_parallel_borda/printout_new.txt'
